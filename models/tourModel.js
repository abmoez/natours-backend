...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message:
          'Difficulty must be either: easy or medium or difficult',
      },
    },
    ratingsAverage: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // this here points only to new created documents, not update
    ...
    imageCover: {
      type: String,
      required: 'A tour must have a cover',
    },
    images: [String],
    createAt: {
      type: Date,
...
tourSchema.post('save', function (doc, next) {
  console.log(`Tour ${doc.name} is saved ...`);
  next();
});
*/
